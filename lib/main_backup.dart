        ...
        children: [
          ...
          FlutterMap(
            ...
            children: [
              ...
              // ----------------------------------------
              // SELECTED SIGNAL ROUTE
              // ----------------------------------------

              List<LatLng> displayRoute = roadRoute;

              if (widget.corridorActive &&
                  widget.activeSignalIndex >= 0 &&
                  widget.activeSignalIndex < signalRoutes.length) {
                displayRoute =
                    signalRoutes[widget.activeSignalIndex];
              } else if (!widget.corridorActive &&
                  selectedSignalIndex >= 0 &&
                  selectedSignalIndex < signalRoutes.length) {
                displayRoute =
                    signalRoutes[selectedSignalIndex];
              }
